...
# cfg.model.flame_tex_path = os.path.join(cfg.deca_dir, 'data', 'FLAME_texture_data/texture_data_256.npy')
...
cfg.loss = CN()
cfg.loss.lmk = 1.0
cfg.loss.mouthkc = 1.0
cfg.loss.useWlmk = True# 新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新新
cfg.loss.lmk_num = 68
cfg.loss.eyed = 1.0
cfg.loss.lipd = 0.5
cfg.loss.photo = 2.0
